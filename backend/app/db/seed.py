...
SET_AND_FORGET_TEMPLATE = {
    ...
    "description": (
        ...
        "Identify the HTF trend on Daily/Weekly, mark fresh supply/demand zones as AOIs, "
        "wait for a liquidity sweep into the AOI, then enter on a lower-timeframe structure "
        "shift (HH/HL for longs, LL/LH for shorts) with pre-defined risk. "
        "Set-and-forget execution: place the order, set stop and target, walk away."
    ),
    "timeframe": "4H",
    ...
    "assumptions": [
        ...
        "Time stop: if structure hasn't progressed after a set number of candles, flatten and wait for a fresh trigger.",
